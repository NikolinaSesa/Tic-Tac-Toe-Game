...
export const WindowContext = React.createContext<IWindowContextProps>({ clientHeight: 0, clientWidth: 0, });

export const WindowContextProvider: React.FC<{children : any}> = ({children}) => {
